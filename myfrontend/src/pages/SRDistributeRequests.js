...
import RequestModalSRDis from './RequestModalSRDis';
import './RequestList.css';

const SRDistributeRequests = () => {
  ...
  const fetchRequests = useCallback(async () => {
    try {
      const response = await requestService.getRequests({
        status: 5, // Фильтрация по статусу 5 (проверено)
...
export default SRDistributeRequests;
